  ...
  const testimonials = [
    {
      ...
      location: 'Auburn, AL',
      rating: 5,
      text: 'Tiger Iron changed my life. The 24/7 access means I can work out at 5am before work. The community is incredibly supportive and the equipment is top-notch.',
    ...
    },
    {
      ...
      location: 'Auburn, AL',
      rating: 5,
      text: 'Best gym in Auburn, hands down. The personal trainers are knowledgeable and the facilities are always clean. Love being able to train on my schedule.',
    ...
    },
    {
      ...
      location: 'Opelika, AL',
      rating: 5,
      text: 'The app makes check-in seamless and I love the class schedule. Tiger Iron has everything I need - from free weights to cardio equipment. Highly recommend!',
